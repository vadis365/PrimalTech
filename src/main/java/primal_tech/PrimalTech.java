...
@Mod(modid = "primal_tech", name = "primal_tech", version = "0.2.91234567890123456789012345678901234567890", guiFactory = "primal_tech.configs.ConfigGuiFactory", dependencies = "after:*")
