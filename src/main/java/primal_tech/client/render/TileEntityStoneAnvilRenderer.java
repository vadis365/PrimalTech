...
public class TileEntityStoneAnvilRenderer extends TileEntitySpecialRenderer<TileEntityStoneAnvil> {
	...
	@Override
	public void renderTileEntityAt(TileEntityStoneAnvil tile, double x, double y, double z, float partialTicks, int destroyStage) {
		IBlockState state = tile.getWorld().getBlockState(tile.getPos());

		if(state == null || state.getBlock() != PrimalTech.STONE_ANVIL)
			return;
